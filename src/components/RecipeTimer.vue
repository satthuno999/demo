...
export default {
    ...
    mounted() {
        ...
        this.audio = new Audio(
            linkTo("demo", "assets/alarm-continuous.mp3")
        )

        // For now, the alarm should play continuously until it is dismissed
        // See https://github.com/nextcloud/demo/issues/671#issuecomment-1279030452
    ...
    methods: {
        onTimerEnd() {
            ...
            window.setTimeout(async () => {
                ...
                await showSimpleAlertModal(t("demo", "Cooking time is up!"))

                // Stop audio after the alert is confirmed
                this.audio.pause()

                // demo.notify(t('demo', 'Cooking time is up!'))
                $this.countdown = null
