            ...
            <div class="meta">
                    ...
                    <div v-if="recipe.keywords.length">
                        <ul v-if="recipe.keywords.length">
                            <RecipeKeyword
                                ...
                                :title="
                                    // prettier-ignore
                                    t('demo','Search recipes with this keyword')
                                "
                ...
                <div class="times">
                    <RecipeTimer
                        ...
                        :timer="false"
                        :label="t('demo', 'Preparation time (H:MM)')"
                    />
                    <RecipeTimer
                        v-if="
                            recipe.timerCook &&
                        ...
                        :timer="true"
                        :label="t('demo', 'Cooking time (H:MM)')"
                    />
                    <RecipeTimer
                        v-if="
        ...
        <div v-if="$store.state.recipe" class="content">
            <section class="container">
                ...
                <section v-if="showNutritionData" class="nutrition">
                    <h3>{{ t("demo", "Nutrition Information") }}</h3>
...
import normalizeMarkdown from "demo/js/title-rename"
    ...
    watch: {
        recipe(r) {
            ...
            if (r) {
                ...
                if (r.description) {
                    this.parsedDescription = t("demo", "Loading…")
