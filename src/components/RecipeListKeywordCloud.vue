    ...
    <div class="kw-container">
        <div class="kw" :class="{ max: isMaximized }">
            ...
            >
                ...
                <RecipeKeyword
                    ...
                    :title="
                        // prettier-ignore
                        t('demo','Keyword not contained in visible recipes')
                    "
        ...
        <div v-if="uniqKeywords.length > 0" class="settings-buttons">
            ...
            <button
                ...
                :title="t('demo', 'Toggle keyword area size')"
    ...
    computed: {
        ...
        orderButtonTitle() {
            return this.isOrderedAlphabetically
                ? t("demo", "Order keywords by number of recipes")
                : t("demo", "Order keywords alphabetically")
        },
        /**
