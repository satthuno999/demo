...
```
https://cloud.domain.org/index.php/apps/demo/ampache
```
...
```
https://cloud.domain.org/index.php/apps/demo/subsonic
```
...
The Music app back-end implements the [Shiva API](https://shiva.readthedocs.org/en/latest/resources/base.html) except the resources `/artists/<int:artist_id>/shows`, `/tracks/<int:track_id>/lyrics` and the meta resources. You can use this API under `https://own.cloud.example.org/index.php/apps/demo/api/`.
			...
			"albums": [
				{
					...
					"year": 1998,
					"disk" : 1,
					"cover": "/index.php/apps/demo/api/album/16/cover",
					"id": 16,
					"tracks": [
						{
			...
			"albums": [
				{
					...
					"year": 2002,
					"disk" : 1,
					"cover": "/index.php/apps/demo/api/album/22/cover",
					"id": 22,
					"tracks": [
						{
