...
/**
 * @coversDefaultClass \OCA\demo\Helper\HTMLParser\HttpMicrodataParser
 * @covers \OCA\demo\Helper\HTMLParser\AttributeNotFoundException
 * @covers ::<protected>
 * @covers ::<private>
 * @author christian
 *
...
class HttpMicrodataParserTest extends TestCase {
	/**
	 * @covers ::__construct
	 * @covers \OCA\demo\Helper\HTMLParser\AbstractHtmlParser
	 */
