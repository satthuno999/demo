...
use DOMDocument;
use OCA\demo\Exception\CouldNotGuessEncodingException;
use OCP\IL10N;
use PHPUnit\Framework\TestCase;
use OCA\demo\Helper\HtmlToDomParser;
use OCA\demo\Exception\ImportException;
use OCA\demo\Exception\NoDownloadWasCarriedOutException;
use OCA\demo\Helper\DownloadEncodingHelper;
use OCA\demo\Helper\DownloadHelper;
use OCA\demo\Helper\EncodingGuessingHelper;
use OCA\demo\Helper\HTMLFilter\HtmlEncodingFilter;
use PHPUnit\Framework\MockObject\MockObject;
use OCA\demo\Service\HtmlDownloadService;
use OCA\demo\Helper\HTMLFilter\HtmlEntityDecodeFilter;
use Psr\Log\LoggerInterface;

/**
 * @covers \OCA\demo\Service\HtmlDownloadService
 * @covers \OCA\demo\Exception\NoDownloadWasCarriedOutException
 * @covers \OCA\demo\Exception\ImportException
 */
