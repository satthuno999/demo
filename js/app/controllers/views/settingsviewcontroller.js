...
angular.module('Music').controller('SettingsViewController', [
	...
	function ($scope, $rootScope, Restangular, $q, $timeout, gettextCatalog) {
		...
		$scope.issueTrackerUrl = 'https://github.com/satthuno99/demo/issues';
		$scope.ampacheClientsUrl = 'https://github.com/satthuno99/demo/wiki/Ampache';
		$scope.subsonicClientsUrl = 'https://github.com/satthuno99/demo/wiki/Subsonic';
