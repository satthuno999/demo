OC.L10N.register(
    ...
    "Could not parse recipe tools. It is no array." : "Could not parse recipe tools. It is no array.",
    ...
    "demo" : "demo",
    "An integrated demo using schema.org JSON files as recipes" : "An integrated demo using schema.org JSON files as recipes",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder.",
