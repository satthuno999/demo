OC.L10N.register(
    ...
    "demo" : "Libru de retzetas",
    "An integrated demo using schema.org JSON files as recipes" : "Unu libru de retzetas integradu chi impreat archìvios JSON schema.org comente retzetas",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "As fatu s'atzessu cun unu contu de persone invitada. Duncas non tenes su permissu de generare archìvios e cartellas arbitràrias in custa istàntzia Nextcloud. Pro impreare custa aplicatzione comente persone invitada, depes inditare una cartella in ue sunt sarvadas is retzetas. As a tènnere bisòngiu de is permissos de iscritura pro custa cartella.",
