OC.L10N.register(
    ...
    "demo" : "Kookboek",
    "An integrated demo using schema.org JSON files as recipes" : "Een geïntegreerd kookboek dat gebruikt maakt van JSON-bestanden volgens het schema.org-formaat voor recepten",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Je bent ingelogd met een gastenaccount. Daarom is het niet mogelijk om willekeurige bestanden en mappen aan te maken op deze Nextcloud-instantie. Om de demo-app als gast te kunnen gebruiken, moet je een map opgeven waarin alle recepten zijn opgeslagen. Je hebt schrijfmachtiging nodig voor deze map.",
