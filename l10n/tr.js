OC.L10N.register(
    ...
    "demo" : "Yemek kitabı",
    "An integrated demo using schema.org JSON files as recipes" : "Yemek tarifleri için schema.org JSON dosyaları kullanan bütünleşik bir yemek kitabı",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Bir konuk hesabı ile oturum açmışsınız. Bu nedenle, bu Nextcloud kopyasına istediğiniz şekilde dosya ve klasör ekleyemezsiniz. Yemek kitabı uygulamasını konuk olarak kullanabilmek için, tüm tariflerin kaydedileceği bir klasör belirlemelisiniz. Bu klasöre yazma izninizin olması gerekir.",
    ...
    "demo settings" : "Yemek kitabı ayarları",
