OC.L10N.register(
    ...
    "demo" : "Kuchařka",
    "An integrated demo using schema.org JSON files as recipes" : "Vestavěná kuchařka používající pro recepty JSON soubory schema.org",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Jste přihlášeni přes účet pro hosty. Proto na této instanci Nextcloudu nemůžete svévolně vytvářet složky a soubory. Abyste mohli používat aplikaci Kuchařka jako host, musíte určit složku, do které se mají všechny recepty ukládat. Budete potřebovat práva pro zápis do této složky.",
    ...
    "Cooking time (hours:minutes)" : "Doba tepelné úpravy (hodin:minut):",
    ...
    "demo settings" : "Nastavení pro Kuchařku",
