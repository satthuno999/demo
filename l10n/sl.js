OC.L10N.register(
    ...
    "demo" : "Kuhar'ca",
    "An integrated demo using schema.org JSON files as recipes" : "Kuharica v oblaku, ki omogoča prikaz datotek receptov schema.org JSON",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Prijavljeni ste z računom za goste, zato ni mogoče ustvarjati datotek in map. Za uporabo programa Kuhar'ca je treba navesti mapo, kjer so shranjeni vsi recepti, prav tako je treba pridobiti dovoljenje za zapisovanje v to mapo.",
