OC.L10N.register(
    ...
    "Could not parse recipe tools. It is no array." : "Опрема за рецепт не може да се парсира. Није низ.",
    ...
    "demo" : "Кувар",
    "An integrated demo using schema.org JSON files as recipes" : "Интегрисани кувар који користи schema.org JSON фајлове као рецепте",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Пријављени сте на налог госта. Стога вам није дозвољено да креирате произвољне фајлове и фолдере на овој Nextcloud инстанци. Да бисте могли да користите апликацију Кувар као гост, морате да наведете фолдер у којем су смештени сви рецепти. Биће вам потребна права уписа у тај фолдер.",
    ...
    "Toggle editing" : "Укључи/искључи уређивање",
    ...
    "demo settings" : "Подешавања кувара",
