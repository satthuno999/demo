OC.L10N.register(
    ...
    "demo" : "Ricettario",
    "An integrated demo using schema.org JSON files as recipes" : "Un ricettario integrato che utilizza file JSON schema.org come ricette",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Hai effettuato l'accesso con un account ospite. Pertanto, non ti è consentito generare file e cartelle arbitrari su questa istanza Nextcloud. Per poter utilizzare l'applicazione Ricettario come ospite, è necessario specificare una cartella in cui sono memorizzate tutte le ricette. Avrai bisogno dell'autorizzazione di scrittura per questa cartella. ",
