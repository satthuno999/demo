OC.L10N.register(
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Du bist mit einem Gastkonto eingeloggt. Du bist nicht berechtigt, beliebige Dateien und Ordner auf dieser Nextcloud-Instanz zu erzeugen. Um die demo-App als Gast nutzen zu können, musst du einen Ordner angeben, in dem alle Rezepte gespeichert werden. Du benötigst Schreibrechte für diesen Ordner.",
