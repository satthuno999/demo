OC.L10N.register(
    ...
    "demo" : "Llibre de receptes",
    "An integrated demo using schema.org JSON files as recipes" : "Un llibre de receptes integrat que utilitza fitxers JSON de schema.org com a receptes",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Heu iniciat la sessió amb un compte d'invitat. Per tant, no podeu generar fitxers i carpetes arbitràries en aquesta instància de Nextcloud. Per poder utilitzar l'aplicació demo com a convidat, has d'especificar una carpeta on s'emmagatzemen totes les receptes. Necessitareu permís d'escriptura a aquesta carpeta.",
    ...
    "Toggle editing" : "Commuta l'edició",
    ...
    "Loading config failed" : "Ha fallat la càrrega de la configuració",
