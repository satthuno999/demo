OC.L10N.register(
    ...
    "demo" : "Βιβλίο συνταγών",
    "An integrated demo using schema.org JSON files as recipes" : "Ένα ενσωματωμένο βιβλίο μαγειρικής χρησιμοποιώντας αρχεία JSON του schema.org ως συνταγές",
