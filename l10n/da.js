OC.L10N.register(
    ...
    "demo" : "Kogebogen",
    "An integrated demo using schema.org JSON files as recipes" : "En integreret kogebog som benytter schema.org JSON filer som opskrifter",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Du er logget på med en gæstekonto. Derfor har du ikke tilladelse til at generere vilkårlige filer og mappe på denne Nextcloud-instans. For at bruge demo-app'en som en gæst skal du angive en mappe hvori alle opskrifter gemmes. Til denne mappe har du brug for skriverettigheder.",
