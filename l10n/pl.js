OC.L10N.register(
    ...
    "Could not parse recipe tools. It is no array." : "Nie udało się przeanalizować przyborów przepisu. To nie jest tablica.",
    ...
    "demo" : "Książka kucharska",
    "An integrated demo using schema.org JSON files as recipes" : "Zintegrowana książka kucharska wykorzystująca pliki JSON schema.org jako przepisy kulinarne",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Jesteś zalogowany na koncie gościa. Dlatego nie możesz tworzyć dowolnych plików i katalogów na tej instancji Nextcloud. Aby móc korzystać z aplikacji Książka kucharska (demo) jako gość, należy określić katalog, w którym przechowywane są wszystkie przepisy. Będziesz potrzebował uprawnień do zapisu w tym katalogu.",
    ...
    "demo settings" : "Ustawienia książki kucharskiej",
