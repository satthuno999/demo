OC.L10N.register(
    ...
    "demo" : "Kuchárska kniha",
    "An integrated demo using schema.org JSON files as recipes" : "Integrovaná kuchárska kniha používa ako recepty súbory JSON schema.org",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Ste prihlásení pomocou účtu hosťa. Preto v tejto inštancii Nextcloud nemáte oprávnenie generovať ľubovoľné súbory a priečinky. Aby ste mohli aplikáciu Kuchárska kniha používať ako hosť, musíte určiť priečinok, kde sú uložené všetky recepty. Do tohto priečinka budete potrebovať povolenie na zápis.",
