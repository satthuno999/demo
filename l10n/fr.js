OC.L10N.register(
    "demo",
    {
    "No image with the matching MIME type was found on the server." : "Aucune image au format MIME n'à été trouvée sur le serveur",
    "Recipe with ID %d was not found in database." : "Recette avec l'ID %d non trouvée dans la base de données.",
    "Downloading of a file failed returned the following error message: %s" : "Le téléchargement d'un fichier a renvoyé le message d'erreur suivant: 1%s",
    "No content encoding was detected in the content." : "Aucun encodage de contenu détecté dans le contenu.",
    "The given image for the recipe %s cannot be parsed. Aborting and skipping it." : "L'image pour la recette 1%s ne peut être traitée. Non traitée et ignorée.",
    ...
    "demo" : "Livre de recettes",
    "An integrated demo using schema.org JSON files as recipes" : "Un livre de recettes intégré utilisant les fichiers JSON de schema.org pour stocker les recettes",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Vous êtes connecté en tant qu'invité. De ce fait, vous ne pouvez pas créer de fichiers et dossiers dans cette instance Nextcloud. Pour pouvoir utiliser l'application demo, Vous devez indiquer un dossier où les recettes seront stockées. Vous devez avoir les droits d'écriture dans ce dossier.",
    ...
    "demo settings" : "Paramètres du livre de cuisine",
