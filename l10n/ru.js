OC.L10N.register(
    ...
    "demo" : "Кулинарная книга",
    "An integrated demo using schema.org JSON files as recipes" : "Интегрированная кулинарная книга, использующая JSON-файлы schema.org для рецептов",
