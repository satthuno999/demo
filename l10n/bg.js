OC.L10N.register(
    ...
    "demo" : "Готварска книга",
    "An integrated demo using schema.org JSON files as recipes" : "Интегрирана готварска книга, използваща JSON файлове schema.org като рецепти",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Влезли сте с профил на гост. Следователно не ви е позволено да генерирате произволни файлове и папки в този екземпляр на Nextcloud. За да можете да използвате приложението demo като гост, трябва да посочите папка, където се съхраняват всички рецепти. Ще ви трябва право за запис в тази папка.",
    ...
    "demo settings" : "Настройки на приложението demo /готварска книга/",
