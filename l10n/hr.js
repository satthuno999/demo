OC.L10N.register(
    ...
    "demo" : "Kuharica",
    "An integrated demo using schema.org JSON files as recipes" : "Integrirana kuharica koja primjenjuje schema.org JSON datoteke kao recepte",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Prijavljeni ste s računom gosta. Stoga vam nije dopušteno generirati proizvoljne datoteke i mape na ovoj instanci Nextclouda. Kako biste se mogli koristiti aplikacijom demo kao gost, morate odrediti mapu u kojoj su pohranjeni svi recepti. Trebat će vam dopuštenje za pisanje u ovu mapu.",
    ...
    "Toggle editing" : "Uključi/isključi uređivanje",
