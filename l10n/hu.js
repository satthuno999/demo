OC.L10N.register(
    ...
    "demo" : "Receptkönyv",
    "An integrated demo using schema.org JSON files as recipes" : "Egy integrát receptkönyv schema.org JSON fájlok használatával",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Vendégfiókkal van bejelentkezve, ezért nem hozhat létre tetszőleges fájlokat és mappákat ezen a Nextcloud példányon. Ahhoz, hogy vendégként használhassa a Receptkönyv alkalmazást, meg kell adnia egy mappát, ahol az összes recept tárolásra kerül. Írási jogosultságra lesz szüksége ebben a mappában.",
    ...
    "demo settings" : "Receptkönyv beállításai",
