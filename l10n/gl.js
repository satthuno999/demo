OC.L10N.register(
    ...
    "in %s" : "en %s",
    "demo" : "Libro de cociña",
    "An integrated demo using schema.org JSON files as recipes" : "Un libro de receitas integrado que usa os ficheiros JSON de schema.org como receitas",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Accedeu cunha conta de convidado. Polo tanto, non se lle permite xerar ficheiros e cartafoles arbitrarios nesta instancia de Nextcloud. Para poder usar a aplicación demo como convidado, cómpre especificar un cartafol onde se almacenen todas as receitas. Necesitará permiso de escritura nese cartafol.",
