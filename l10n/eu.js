OC.L10N.register(
    ...
    "Could not parse recipe tools. It is no array." : "Ezin izan dira errezetaren tresnak analizatu. Ez dago matrizerik.",
    ...
    "demo" : "Errezeta-liburua",
    "An integrated demo using schema.org JSON files as recipes" : "Errezeta-liburu integratua schema.org-eko JSON fitxategiak erabiliz errezeta gisa",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Gonbidatu kontu batekin zaude saioa hasita. Horregatik, ezin duzu fitxategi eta karpeta arbitrariorik sortu zure Nextcloud instantzian. Gonbidatu gisa Errezeta-liburua erabiltzeko, errezeta guztiak dauden karpeta bat zehaztu behar duzu. Bertan idazteko baimena eduki behar duzu.",
    ...
    "demo settings" : "Errezeta-liburuaren ezarpenak",
