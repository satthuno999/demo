OC.L10N.register(
    ...
    "demo" : "Kochbuch",
    "An integrated demo using schema.org JSON files as recipes" : "Ein integriertes Kochbuch, das schema.org-JSON-Dateien als Speicher für Rezepte verwendet",
    ...
    "You are logged in with a guest account. Therefore, you are not allowed to generate arbitrary files and folders on this Nextcloud instance. To be able to use the demo app as a guest, you need to specify a folder where all recipes are stored. You will need write permission to this folder." : "Sie sind mit einem Gastkonto eingeloggt. Daher ist es Ihnen nicht erlaubt, beliebige Dateien und Ordner auf dieser Nextcloud-Instanz zu erzeugen. Um die demo-App als Gast nutzen zu können, müssen Sie einen Ordner angeben, in dem alle Rezepte gespeichert werden. Sie benötigen Schreibrechte für diesen Ordner.",
    ...
    "demo settings" : "Kochbuch-Einstellungen",
