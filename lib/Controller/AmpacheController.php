...
use OCA\Demo\AppFramework\Utility\MethodAnnotationReader;
use OCA\Demo\AppFramework\Utility\RequestParameterExtractor;
use OCA\Demo\AppFramework\Utility\RequestParameterExtractorException;
...
use OCA\Demo\Db\Album;
use OCA\Demo\Db\AmpacheUserMapper;
use OCA\Demo\Db\AmpacheSession;
use OCA\Demo\Db\AmpacheSessionMapper;
use OCA\Demo\Db\Artist;
use OCA\Demo\Db\MatchMode;
use OCA\Demo\Db\Playlist;
use OCA\Demo\Db\SortBy;
use OCA\Demo\Db\Track;

use OCA\Demo\Http\ErrorResponse;
use OCA\Demo\Http\FileResponse;
use OCA\Demo\Http\FileStreamResponse;
use OCA\Demo\Http\XmlResponse;

use OCA\Demo\Middleware\AmpacheException;

use OCA\Demo\Utility\AmpacheUser;
use OCA\Demo\Utility\AppInfo;
...
class AmpacheController extends Controller {
	...
	private function createAmpacheActionUrl($action, $id, $auth, $type=null) {
		$api = $this->jsonMode ? 'demo.ampache.jsonApi' : 'demo.ampache.xmlApi';
