...
use OCA\Demo\Middleware\SubsonicException;
...
use OCA\Demo\Utility\PlaceholderImage;
...
class SubsonicController extends Controller {
	...
	private function artistImageUrl(string $id) : string {
		...
		return $this->urlGenerator->linkToRouteAbsolute('demo.subsonic.handleRequest', ['method' => 'getCoverArt'])
