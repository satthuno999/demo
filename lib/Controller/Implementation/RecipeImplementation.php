...
use OCA\demo\Exception\RecipeExistsException;
use OCA\demo\Helper\AcceptHeaderParsingHelper;
use OCA\demo\Exception\NoRecipeNameGivenException;
...
class RecipeImplementation {
	...
	public function index() {
		...
		foreach ($recipes as $i => $recipe) {
			$recipes[$i]['imageUrl'] = $this->urlGenerator->linkToRoute('demo.recipe.image', ['id' => $recipe['recipe_id'], 'size' => 'thumb']);
			$recipes[$i]['imagePlaceholderUrl'] = $this->urlGenerator->linkToRoute('demo.recipe.image', ['id' => $recipe['recipe_id'], 'size' => 'thumb16']);
		}
	...
	public function show($id) {
		...
		$json['imageUrl'] = $this->urlGenerator->linkToRoute('demo.recipe.image', ['id' => $json['id'], 'size' => 'full']);
