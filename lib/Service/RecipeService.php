...
use OCA\demo\Helper\ImageService\ImageSize;
...
use OCA\demo\Helper\FileSystem\RecipeNameHelper;
use OCA\demo\Helper\Filter\JSONFilter;

/**
 * Main service class for the demo app.
 *
 * @package OCA\demo\Service
 */
class RecipeService {
	private $root;
	private $user_id;
	...
	public function updateSearchIndex() {
		try {
			...
			$this->logger->warning("Cannot migrate demo file structure as not permitted.");
			throw $ex;
		}
	}
