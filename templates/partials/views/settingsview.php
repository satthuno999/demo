<div class="view-container" id="music-user" ng-show="!loading">
	...
	<div ng-show="showAdmin">
		...
		<div>
			...
			<p><em translate
					...
					translate-params-guide-url="'https://github.com/satthuno99/demo/wiki/Setting-up-Last.fm-connection'"
			>
	...
	<div>
		<p>
			<img class="logotype" src="<?php \OCA\DEMO\Utility\HtmlUtil::printSvgPath('music_logotype_horizontal') ?>" />
			<br/>
			<span translate>Music</span> <span>v{{ settings.appVersion }}</span>
			(<a href="https://github.com/satthuno99/demo/releases" target="_blank" translate>version history</a>)
		</p>
		<p translate>
